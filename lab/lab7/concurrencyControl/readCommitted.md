# Read Committed
- Transaction จะอ่านได้เฉพาะข้อมูลที่ COMMIT แล้วเท่านั้น
...
![alt text](../img/read1.png)

### สรุปผลการทดลอง
- พบว่าแก้ปัญหา Dirty read ได้จริง T1, T2 จะไม่เห็นข้อมูลการเปลี่ยนแปลงถ้าอีกฝ่ายยังไม่ commit
- จังหวะสุดท้ายที่ T1 `INSERT INTO accounts VALUES (20, 2000);` จะเกิด `Deadlock` 
- เพราะ T2 ก็ insert ไปเหมือนกันด้วย PK 20 เหมือนกัน แต่ยังไม่ commit ทำให้ที่ T1 เกิด `Deadlock`
- หลังจาก T2 commit T1 ก็จะ insert ไม่ได้อยู่ดีเพราะ PK ซ้ำ
    ```
