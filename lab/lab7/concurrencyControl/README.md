...
![alt text](../img/setup1.png)

![alt text](../img/setup2.png)

![alt text](../img/setup3.png)

![alt text](../img/setup4.png)

![alt text](../img/setup5.png)
...
- step3:
    ...
    ```
- step4: ถ้าทุกอย่างถูกต้องเมื่อ `Select * from accounts;` จะเจอข้อมูลที่ insert ไป และ `\dt` ดูจะเจอตารางที่พึ่งสร้าง

![alt text](../img/setup7.png)
